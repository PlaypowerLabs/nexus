...
cp -r apps/landing-minimal-clean/* public-build/minimal/
cp -r apps/landing-grid-showcase/* public-build/grid/
cp -r apps/landing-hero-focused/* public-build/hero/
cp -r apps/landing-gamified-interactive/* public-build/gamified/
